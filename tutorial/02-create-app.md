...
1. 将 "**产品名称**" `GraphTutorial`和 "**语言**" 设置为 "**目标-C**"。
1. 填写其余字段，然后选择 "**下一步**"。
1. 选择项目的位置并选择 "**创建**"。
...
1. 展开 Xcode 中的 " **GraphTutorial** " 文件夹，然后选择**viewcontroller.m**文件。
1. 在**文件检查器**中，将文件的**名称**更改为`SignInViewController.m`。
...
1. 选择 " **viewcontroller.m** " 文件。
1. 在**文件检查器**中，将文件的**名称**更改为`SignInViewController.h`。
1. 打开**SignInViewController** ，并将的`ViewController`所有实例更改为`SignInViewController`。
...
1. 打开**WelcomeViewController** ，并将以下代码添加到`@interface`声明中。
...
1. 打开**CalendarViewController** ，并将以下代码添加到`@interface`声明中。
...
1. 打开**SpinnerViewController** ，并将以下代码添加到`@interface`声明中。
